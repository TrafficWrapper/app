...
class TransportService : Service() {
    ...
    companion object {
        const val ACTION_START = "pro.trafficwrapper.action.START"
        const val ACTION_STOP = "pro.trafficwrapper.action.STOP"
        const val EXTRA_FAKE_CLOCK_SKEW_SECONDS =
            "pro.trafficwrapper.extra.FAKE_CLOCK_SKEW_SECONDS"
