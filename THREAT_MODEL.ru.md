...
- SOCKS domain targets резолвятся через AWG netstack DNS servers внутри tunnel.
  App не должен fallback'иться на host OS plaintext resolver для proxied domain
  names.
