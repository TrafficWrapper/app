...
- SOCKS domain targets резолвятся через AWG netstack DNS внутри tunnel. Client
  configs могут задавать `dns_servers`; иначе app inject'ит public in-tunnel
  default (`1.1.1.1`, `1.0.0.1`). App не должен fallback'иться на host OS
